...
tool returns a document's OCR'd text unless you ask for it: `get_document` gives
you the fields, `get_document_content` the text. Tags, correspondents, document types
